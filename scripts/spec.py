...
FEATURES: tuple[Feature, ...] = (
    ...
    Feature("fun_ship", "fun", "Ship two members", "M2", Status.PLANNED,
            Layer.GATEWAY, "UserRegisters.py:216-250", ("/ship", "/shippar")),
    ...
    Feature("fun_firecracker", "fun", "Firecracker sequence", "M2", Status.PLANNED,
            Layer.GATEWAY, "Miscellaneous.py:226-238", ("/firecracker", "/rojao", "/fogos")),
    Feature("fun_complaint", "fun", "Complaint bit", "M2", Status.PLANNED,
            Layer.GATEWAY, "Miscellaneous.py:240-259", ("/complaint", "/milton", "/queja")),
    ...
    Feature("util_everyone", "util", "Ping every member", "M2", Status.PLANNED,
            Layer.WORKER, "UserRegisters.py:97-146", ("/everyone", "@everyone"),
            "v1 does one backend call per user; batch it"),
    Feature("util_calladms", "util", "Call the admins", "M2", Status.PARTIAL,
            Layer.GATEWAY, "UserRegisters.py:168-203", ("/adm", "@admin", "/report"),
            "group ping done; v1 also DMs each admin - needs a cb-worker fan-out job"),
    ...
    Feature("util_youtube", "util", "YouTube search", "M2", Status.PLANNED,
            Layer.GATEWAY, "SocialContent.py:172-189", ("/youtube",)),
